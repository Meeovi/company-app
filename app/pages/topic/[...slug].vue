        ...
        <section data-bs-version="5.1" class="nichem5 features4 cid-uYyqLlrkj2" id="features04-8">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="item features-image col-12 col-md-6 col-lg-4" v-for="menu in activeMenus" :key="menu?.id">
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                ...
                                <h5 class="item-title mbr-fonts-style display-7">
                                    <strong>{{ menu?.description }}&nbsp;</strong></h5>

                                <NuxtLink :to="`/topic/${menu?.slug}`" class="mbr-text mbr-fonts-style mt-3 display-4">
                                    Visit</NuxtLink>
                            </div>
...
<script setup>
    ...
    const {
        ...
        return $directus.request($readItem('pages', '84', {
            fields: ['*', {
                '*': ['*']
            }]
        }))
